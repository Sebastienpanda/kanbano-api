...
const docTemplate = `{
    ...
    "paths": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.TaskGuest"
                            }
                        }
                    },
                    "400": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.updateTaskGuestInvitationBody"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.memberProfileResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/roles": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Task ID (requires workspace_id)",
                        "name": "task_id",
                        "in": "query"
                    }
                ],
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.AbilityRule"
                            }
                        }
                    },
                    "400": {
        ...
        "/workspaces/{id}/columns/{columnId}/tasks/{taskId}/guests": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.inviteTaskGuestBody"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.setWorkspaceRoleBody"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.TaskRole"
                            }
                        }
                    },
                    "400": {
    ...
    "definitions": {
        ...
        "handler.memberProfileResponse": {
            ...
            "properties": {
                ...
                "workspaces": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.WorkspaceRole"
                    }
                }
            }
        },
        ...
        "handler.updateTaskGuestInvitationBody": {
            "type": "object",
            "required": [
                "status"
            ],
